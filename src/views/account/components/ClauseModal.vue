<template>
  <el-dialog
    ...
    <div style="height: 450px; overflow: auto">
      ...
      <h4>六、续约</h4>
      <p class="section">付费账户在服务届满前，可按最新的云POS账户服务说明和账户服务协议的规定向云POS提出续签付费版账户服务申请。申请通过云POS的审核且按约定支付相关费用后，账户服务顺延。</p>
      <h4>七、服务终止</h4>
      <p class="section">云POS有权在告知或未经告知的情况时，在下列情形下随时终止、取消或拒绝账户服务。一旦您的账户服务被终止，您将不能在云POS发布信息，也不能让别人代为发布信息；同时您在云POS的注册资料及所有相关信息均会被删除或丢弃。对于账户的以下行为，云POS有权暂停或终止对其的服务：</p>
      <p>
      ...
      <p class="section">在注册过程中，您可自主选择一个登录名和密码，并须对其保密性负责，同时对使用该登录名和密码的所有活动负责。您同意：</p>
      <p>
      ...
      <h4>十一、链接</h4>
      <p class="section">云POS含有与其他网站的链接。云POS网站与链接的网站有合作关系，但并不能控制这些网站及其所提供的资源，所以云POS网站对链接网站上的内容、广告、服务、产品信息的真实有效性不负责任，并且对因链接网站上的内容、广告、服务、产品信息的失实而造成的损失不负任何法律责任。</p>
      <h4>十二、对所收集信息的声明</h4>
      <p>
      ...
      <p class="section">云POS的所有内容版权属广州市超赢信息科技有限公司所有，严禁未经广州市超赢信息科技有限公司书面许可的任何形式的部分或全部拷贝使用。版权所有翻版必究。</p>
      <h4>十五、责任免除</h4>
      <p>
